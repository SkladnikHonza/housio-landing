          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://facebook.com/housioapp" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-white/20 transition" style={{ background: 'rgba(255,255,255,0.1)' }}>
