      ...
      <section className="px-6 py-20 lg:py-24" style={{ background: 'linear-gradient(135deg, var(--bg-warm) 0%, var(--bg-clean) 100%)' }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a className="inline-flex items-center gap-2 text-base font-medium text-white px-8 py-4 rounded-xl hover:opacity-90 transition cursor-pointer" style={{ background: 'var(--teal-900)' }}>
              Vyzkoušet zdarma
              <ArrowRight className="w-4 h-4" />
            </a>
            <a className="inline-flex items-center text-base font-medium px-8 py-4 rounded-xl bg-white hover:bg-white/80 transition cursor-pointer" style={{ color: 'var(--teal-900)' }}>
              Kontakt
            </a>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-3">
                ...
                <a className="w-8 h-8 rounded-lg flex items-center justify-center cursor-pointer hover:bg-white/20 transition" style={{ background: 'rgba(255,255,255,0.1)' }}>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm" style={{ color: 'rgba(255,255,255,0.8)' }}>
                <li className="hover:text-white transition cursor-pointer">Funkce</li>
                <li className="hover:text-white transition cursor-pointer">Ceny</li>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm" style={{ color: 'rgba(255,255,255,0.8)' }}>
                <li className="hover:text-white transition cursor-pointer">O nás</li>
                <li className="hover:text-white transition cursor-pointer">Blog</li>
                <li className="hover:text-white transition cursor-pointer">Kontakt</li>
              </ul>
            </div>
