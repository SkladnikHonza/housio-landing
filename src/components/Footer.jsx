        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-3">
                <a href="https://instagram.com/housio.app" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-white/20 transition" style={{ background: 'rgba(255,255,255,0.1)' }}>
                ...
                <a href="https://facebook.com/housioapp" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-white/20 transition" style={{ background: 'rgba(255,255,255,0.1)' }}>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm" style={{ color: 'rgba(255,255,255,0.8)' }}>
                ...
                <li><Link href="/smazani-uctu" className="hover:text-white transition cursor-pointer">{t('legalDeleteAccount')}</Link></li>
          ...
          <div className="pt-8" style={{ borderTop: '0.5px solid rgba(255,255,255,0.15)' }}>
            <p className="text-sm text-center leading-relaxed" style={{ color: 'rgba(255,255,255,0.7)' }}>
              US Europe Group s.r.o. · Třebovická 5050/78, 722 00 Ostrava · IČO 06779808 · DIČ CZ06779808 · <a href="mailto:housio@housio.app" className="hover:text-white transition cursor-pointer" style={{ color: 'inherit', textDecoration: 'underline' }}>housio@housio.app</a>
            </p>
